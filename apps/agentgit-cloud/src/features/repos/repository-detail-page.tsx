      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.9fr)]">
          ...
          <Card className="space-y-4">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <div className="rounded-[var(--ag-radius-md)] border border-[var(--ag-border-subtle)] bg-[var(--ag-bg-elevated)] px-4 py-3">
                <div className="text-xs uppercase tracking-[0.06em] text-[var(--ag-text-secondary)]">Agent status</div>
        ...
        <Card className="space-y-4">
          ...
          <div className="space-y-3 text-sm">
            <div>
              <div className="text-xs uppercase tracking-[0.06em] text-[var(--ag-text-secondary)]">Default branch</div>
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.06em] text-[var(--ag-text-secondary)]">Latest workflow</div>
              <div className="mt-1 font-medium">{repository.latestWorkflowName ?? "No governed runs yet"}</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-[0.06em] text-[var(--ag-text-secondary)]">Last updated</div>
              <div className="mt-1 font-medium">{formatAbsoluteDate(repository.lastUpdatedAt)}</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-[0.06em] text-[var(--ag-text-secondary)]">Workspace root</div>
