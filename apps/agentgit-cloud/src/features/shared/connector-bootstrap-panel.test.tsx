    ...
    render(
      <ConnectorBootstrapPanel
        bootstrapDetails={{
          ...
          commandHint:
            "agentgit-cloud-connector bootstrap --bootstrap-token agcbt_test_123 && agentgit-cloud-connector run --workspace-root /tmp/repo",
        }}
        waitingForConnection
      />,
    );

    expect(screen.getByText(/agentgit-cloud-connector bootstrap/)).toBeTruthy();
    expect(screen.getByText(/agentgit-cloud-connector run/)).toBeTruthy();
