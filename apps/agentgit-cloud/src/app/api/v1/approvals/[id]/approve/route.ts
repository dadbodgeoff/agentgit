...
export async function POST(
  ...
  try {
    ...
    return jsonWithRequestId(
      {
        ...
        resolvedByName: actorName,
        resolvedAt: queuedAt,
        message: `Approval queued for ${connector.machineName}. The connector will deliver it locally and resume the run.`,
    ...
    return jsonWithRequestId({ message: "Could not submit the approval decision. Retry." }, { status: 500 }, requestId);
  }
}
